...
#   DRAKE_DEPRECATION_RUNTIME_SEVERITY=error so pydrake installs its
#     DrakeDeprecationWarning filter at error severity. Without this,
#     pydrake's default "once" filter sits at position 0 of the warnings
#     filter list and shadows PYTHONWARNINGS=error for this category.
#   PYTHONWARNINGS=error so any other Python warning is also promoted
#     to a test failure.
# Use this in place of add_test(NAME ...) for Python tests.
macro(drake_example_add_py_test)
  add_test(${ARGN})
...
macro(drake_example_add_cc_test)
  add_test(${ARGN})
endmacro()